...
def parse():
    ...
    parser.add_argument('--window_stride', type=int, default=40)
    parser.add_argument('--dynamic_length', type=int, default=175)#
    parser.add_argument('--lambda1', type=float, default=0.00001)#to adjust reconstruct_loss
    parser.add_argument('--lambda2', type=float, default=0.00001)  # to adjust modularity_loss
